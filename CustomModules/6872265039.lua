...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/spookzv4/SpookzV4main/"..scripturl, true)
	end
end
...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/spookzv4/SpookzV4/main/"..scripturl, true)
	end
end
...
local function getcustomassetfunc(path)
	if not betterisfile(path) then
		...
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/spookzv4/SpookzV4/main/"..path:gsub("vape/assets", "assets"),
			Method = "GET"
		})
	...
	task.spawn(function()
		pcall(function()
			if not isfile("vape/Profiles/bedwarsdata.txt") then
				local commit = "main"
				for i,v in pairs(game:HttpGet("https://github.com/spookzv4/SpookzV4"):split("\n")) do
				...
				writefile("vape/Profiles/bedwarsdata.txt", game:HttpGet("https://raw.githubusercontent.com/spookzv4/SpookzV4/"..commit.."/CustomModules/bedwarsdata", true))
			end
			...
			repeat
				...
				local newdata = game:HttpGet("https://raw.githubusercontent.com/spookzv4/SpookzV4/"..commit.."/CustomModules/bedwarsdata", true)
